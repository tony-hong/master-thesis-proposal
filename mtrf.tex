...
\begin{figure}[t]
\centering
\includegraphics[width=0.8\textwidth]{ResBOP.png}
...
%     p(a_x | e, b_y)
%         &= \frac{
%         exp(\mathbf{e}\mathbf{W} + \mathbf{b})_{(x)}
%         }{
%         \sum_{i=1}^{|V|} exp(\mathbf{e}\mathbf{W} + \mathbf{b})_{(i)} }   \\
%         &= \frac{
%         [exp(\mathbf{e}\mathbf{W}) exp(\mathbf{b})]_{(x)}
%         }{
%         \sum_{i=1}^{|V|} [exp(\mathbf{e}\mathbf{W}) exp(\mathbf{b})]_{(i)} }   \\
% \end{aligned}
% \end{equation}
